...
When erasing or programming the memory map or flash banks need to be known and this is selected by the mcu or group switch.  The supported mcus and groups are:
mcu=
  M3026xxx
  M3028xxx
  M3029xxx
